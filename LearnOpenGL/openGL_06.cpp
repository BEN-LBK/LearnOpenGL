...
#ifdef __APPLE__
    const char * shaderVsPath = "/Users/ben/Library/Containers/com.lbk.shader/shader_06.vs";
    const char * shaderFsPath = "/Users/ben/Library/Containers/com.lbk.shader/shader_06.fs";
    const char * texturePath = "/Users/ben/Library/Containers/com.lbk.shader/wall.jpg";
#else
    const char * shaderVsPath = "./Shader/shader_06.vs";
    const char * shaderFsPath = "./Shader/shader_06.fs";
    const char * texturePath = "./Texture/wall.jpg";
#endif
    // build and compile shader program
    Shader ourShader(shaderVsPath, shaderFsPath);
